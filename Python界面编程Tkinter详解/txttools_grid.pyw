...
class MY_GUI():
    ...
    def set_init_window(self):
        ...
        # 按钮
        self.str_trans_to_md5_button = Button(self.init_window_name, text="字符串转MD5--->",
        ...
        self.str_trans_to_md5_button = Button(self.init_window_name, text="字符串转BASE64--->",
        ...
        self.str_trans_to_md5_button = Button(self.init_window_name, text="<---BASE64转字符串",
                                              bg="lightblue", width=20, command=self.str_trans_to_md5)  # 调用内部方法  加()为直接调用
        self.str_trans_to_md5_button.grid(row=3, column=67, rowspan=1)
        self.str_trans_to_upper_button = Button(
        ...
        self.str_trans_to_lower_button = Button(
