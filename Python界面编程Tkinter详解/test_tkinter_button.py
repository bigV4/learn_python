...
class buttons:
    def __init__(self):
        ...
        self.click_background_colour = Button(
            root, text='背景色', activebackground='blue')
        self.click_foreground_colour = Button(
            root, text='前景色', activeforeground='blue')
        # 按钮边框大小，bd='边框大小'
        ...
        self.button_face1 = Button(
            root, text='软体雅黑/12/重打印', font=('软体雅黑', 10, 'overstrike'))
        self.button_face2 = Button(
            root, text='宋体/12/斜体', font=('宋体', 10, 'italic'))
        self.button_face3 = Button(
            root, text='黑体/12/加粗', font=('黑体', 10, 'bold'))
        self.button_face4 = Button(
            root, text='楷体/12/下划线', font=('楷体', 10, 'underline'))
        # 按钮高度，height='高度'
