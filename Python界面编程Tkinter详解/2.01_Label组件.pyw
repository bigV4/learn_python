...
tk.Label(root, text="我是标签1").pack(side=tk.LEFT)
tk.Label(root, text="我是标签2").pack(side=tk.LEFT)
tk.Label(root, text="我是标签4").pack(side=tk.LEFT)
tk.Label(root, bitmap="error").pack(side=tk.TOP)
